...
_SYSTEM_PROMPT = (
    ...
    "Scoring guide: Use the FULL 0-1 range. 0 = this dimension is completely "
    "missing or absent. 1 = among the best SKILL.md descriptions you have "
    "ever evaluated. Avoid giving identical scores across dimensions unless "
    "they are truly identical in quality. Each dimension should be scored "
    "independently — do not anchor on previous dimensions.\n\n"
    "Dimensions:\n"
